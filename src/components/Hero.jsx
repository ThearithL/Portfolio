      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            {/* Typing Text */}
            <div className="h-12"> {/* Fixed height prevents layout shift */}
              <span className="bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-4xl tracking-tight text-transparent lg:ml-4">
                {text}
            ...
            {/* Description */}
            <p className="my-4 lg:ml-6 max-w-2xl py-2 font-light tracking-tight text-white leading-relaxed">
              {HERO_CONTENT}
            </p>
          </div>
        </div>
